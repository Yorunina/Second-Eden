...
StartupEvents.registry("attribute", event => {
     ...
     */
    event.createCustom("kubejs:decode_ability", () => new $RangedAttribute("attribute.kubejs.decode_ability", 0, 0, 1024).setSyncable(true))
    /**
     * 加密能力：减少他人监听到自己使用空投能力的概率
     */
    event.createCustom("kubejs:encode_ability", () => new $RangedAttribute("attribute.kubejs.encode_ability", 0, 0, 1024).setSyncable(true))
})
