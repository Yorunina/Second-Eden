...
StartupEvents.registry('item', event => {
    ...
    event.create('iridium_helmet', 'helmet').texture('kubejs:item/iridium_helmet').tier('iridium').tag('minecraft:trimmable_armor').tag(EPIC)
    event.create('iridium_chestplate', 'chestplate').texture('kubejs:item/iridium_chestplate').tier('iridium').tag('minecraft:trimmable_armor').tag(EPIC)
    event.create('iridium_leggings', 'leggings').texture('kubejs:item/iridium_leggings').tier('iridium').tag('minecraft:trimmable_armor').tag(EPIC)
    event.create('iridium_boots', 'boots').texture('kubejs:item/iridium_boots').tier('iridium').tag('minecraft:trimmable_armor').tag(EPIC)
    ...
    event.create('raw_iridium', 'basic').texture('kubejs:item/raw_iridium').tag(EPIC)
})