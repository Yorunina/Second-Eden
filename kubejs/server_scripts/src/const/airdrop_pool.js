...
const StoneAirdropPool = new Map()
    .set('stone', [
        ...
        new AirdropPoolItem('minecraft:red_sand').setMinCount(32).setMaxCount(128).setFortuneCoe(1.5).setChance(0.6),
        new AirdropPoolItem('minecraft:red_sandstone').setMinCount(16).setMaxCount(64).setFortuneCoe(1.5).setChance(0.6),
        new AirdropPoolItem('minecraft:gravel').setMinCount(32).setMaxCount(128).setFortuneCoe(1.5).setChance(0.5),
        new AirdropPoolItem('minecraft:stone_bricks').setMinCount(16).setMaxCount(64).setFortuneCoe(1.5).setChance(0.5),
        new AirdropPoolItem('minecraft:clay').setMinCount(16).setMaxCount(64).setFortuneCoe(1.5).setChance(0.5),
    ]).set('variant_stone', [
...
const OreAirdropPool = new Map()
    .set('raw_ore', [
        ...
        new AirdropPoolItem('minecraft:diamond').setMinCount(8).setMaxCount(16).setFortuneCoe(1.5).setChance(0.3),
        new AirdropPoolItem('minecraft:emerald').setMinCount(16).setMaxCount(32).setFortuneCoe(1.5).setChance(0.5),
        new AirdropPoolItem('minecraft:lapis_lazuli').setMinCount(16).setMaxCount(32).setFortuneCoe(1.5).setChance(0.5),
