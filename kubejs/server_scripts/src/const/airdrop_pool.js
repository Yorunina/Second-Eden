...
const AdvancedAirdropPool = new Map()
    .set('relics', [
        ...
        new AirdropPoolItem('lightmanscurrency:coin_emerald').setMinCount(1).setMaxCount(4).setFortuneCoe(1).setChance(0.3),
    ])
...
const UltraAirdropPool = new Map()
    .set('relics', [
        ...
        new AirdropPoolItem('minecraft:diamond').setMinCount(16).setMaxCount(32).setFortuneCoe(1.5).setChance(0.8),
        ...
        new AirdropPoolItem('kubejs:echo_crystal').setMinCount(4).setMaxCount(8).setFortuneCoe(1).setChance(0.25),
    ]).set('raw_ore', [
        ...
        new AirdropPoolItem('kubejs:raw_iridium').setMinCount(1).setMaxCount(8).setFortuneCoe(1).setChance(0.25),
        new AirdropPoolItem('minecraft:netherite_scrap').setMinCount(4).setMaxCount(32).setFortuneCoe(1.5).setChance(0.25),
    ]).set('altas', [
