...
PlayerEvents.loggedIn(event => {
    ...
    event.server.scheduleInTicks(20, (callback) => {
        if (player.persistentData.getInt('firstJoin') != 1) {
            ...
            player.give(Item.of('eccentrictome:tome', '{"eccentrictome:mods":{ftbquests:{0:{Count:1b,id:"ftbquests:book"}},via_romana:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"via_romana:guide"}}}},"eccentrictome:version":1}'))
